            ...
            <div class="p-5">
              ...
              <form method="post" action="<?php base_url('registrasi/index')?>"class="user">
                <div class="form-group">
                  ...
                  <?php echo form_error('nama', '<div class="text-danger small ml-12">','</div>') ?>
                </div>

                <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Username" name="username">
                <?php echo form_error('username', '<div class="text-danger small ml-12">','</div>') ?>
                </div>
                <div class="form-group row">
                  ...
                  <?php echo form_error('password_1', '<div class="text-danger small ml-12">','</div>') ?>
                  </div>
                  <div class="col-sm-6">
